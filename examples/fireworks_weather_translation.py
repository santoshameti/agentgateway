...
gateway = AgentGateway(AgentType.FIREWORKS, model_id="accounts/fireworks/models/llama-v3p1-70b-instruct")

# Set up Anthropic authentication
gateway.adapter.set_auth(api_key=os.getenv('FIREWORKS_API_KEY'))
